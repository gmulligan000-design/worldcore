...
export default function App() {
  ...
  const { scores, loading, updateMode1, updateMode2, updateMode3, updateMode4, updateMode5 } = useScores()
  ...
  if (mode === 5) return <Mode5 user={user} scores={scores} updateMode5={updateMode5} onBack={() => setMode(null)} />
}
